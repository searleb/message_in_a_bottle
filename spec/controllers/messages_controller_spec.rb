  ...
  # }
   ...
   let(:valid_session) { {} }
	...
	describe "POST create" do
		...
		describe "with valid params" do
			it "creates a new message" do
				expect {
          post :create, {:message => { :message => "wtf" } }
		...
		describe "successful save" do
			it "shows flash success" do
				get :index
				expect(flash[:success]).should_not be_nil
			end
		end

		describe "error save" do
			@user = User.create(email: 'test@example.com', password: 'password', password_confirmation: '')
	...
	describe "GET show" do
		before do 
   	  @msg1 = Message.create!(message: 'what')
	...
	describe "DELETE message" do
		...
		it "should destroy a messge" do
			expect{ delete :destroy, id: @msg1.id }.to change{Message.count}.by(-1)
		end
		it "should redirect to message index" do
			delete :destroy, id: @msg1.id
